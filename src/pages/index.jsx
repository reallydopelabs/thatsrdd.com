          ...
          <div className="mx-auto max-w-xl px-4 sm:px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
            <div>
              ...
              <div className="mt-6 text-lg">
                <ActionLink href="/creators" color="emerald">
        ...
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
          <div className="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:pt-32 lg:pb-4 lg:px-0">
            <div>
              ...
              <div className="mt-6 text-lg">
                <ActionLink href="/businesses" color="purple">
...
function Stack() {
  return (
    <Container className="py-12 lg:py-24">
      ...
      <p className="my-6 max-w-xl text-3xl font-bold leading-normal tracking-tight text-white sm:text-4xl">
        ...
        <div className="mt-12 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16">
          {features.map((feature) => (
            <div key={feature.name}>
              <div>
                <span className="flex h-12 w-12 items-center justify-center rounded-md bg-emerald-400/10 bg-opacity-10">
                  <feature.icon
...
function Budgets() {
  return (
    <div className="py-16 lg:py-24">
      <Container className="relative bg-black py-6">
        <div className="mb-16 max-w-3xl">
          ...
          <p className="my-6 max-w-xl text-lg text-zinc-200">
        ...
        <div className="lg:flex lg:gap-x-6">
          <div className="lg:flex-1">
            <p className="my-4 text-2xl font-bold leading-normal tracking-tight text-white sm:text-3xl">
              Startup
            </p>
            <p className="mx-auto my-4 text-base text-zinc-200">
