...
export function SimpleHero() {
  return (
    <Container className="bg-black pt-12 pb-16 text-center lg:pt-32 lg:pb-32">
      <div className="text-left sm:text-center">
        <h1 className="mx-auto text-4xl font-bold leading-tight tracking-tight text-white sm:text-5xl md:max-w-3xl md:text-6xl">
