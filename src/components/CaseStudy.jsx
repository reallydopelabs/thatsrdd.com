              ...
              <div className="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
                ...
                <div className="relative mt-8 text-lg font-medium text-white">
                  ...
                  <p className="relative">
                    Sam and his team have been such a pleasure to work with over
                    the last year. We're making improvements to the site on a
                    monthly basis and getting actionable feedback and advice in
                    our Slack chats. Their work has been paramount to our growth
                    and we very much look forward to our continued partnership.
                  </p>
                </div>
              </div>
              <cite className="relative flex items-center rounded-b-lg bg-zinc-700 py-5 px-6 not-italic sm:mt-10 sm:items-start sm:py-5 sm:pl-12 sm:pr-10">
                ...
                <span className="relative ml-4 font-semibold leading-6 text-zinc-300 sm:ml-24 sm:pl-1">
                  ...
                  <span className="sm:inline">
                    Founder &amp; Editor, <em>Quillette</em>
                  </span>
                </span>
              </cite>
            </blockquote>
