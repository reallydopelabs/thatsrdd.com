    ...
    <div className="bg-black">
      ...
      <div className="relative">
        <div className="absolute inset-0 flex flex-col" aria-hidden="true">
          ...
          <div className="w-full flex-1 bg-purple-400" />
        </div>
      ...
      <div className="bg-purple-400">
        <div className="mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <h2 className="mb-12 text-center text-base font-semibold text-white">
            We work with businesses and brands of all sizes
          </h2>
          <div className="mt-8 grid grid-cols-2 gap-8 md:grid-cols-4">
            <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
              <Image height={36} src={logoVexus} alt="Vexus" />
            </div>
            <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
              <Image height={36} src={logoVirginOrbit} alt="Virgin Orbit" />
            </div>
            <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
              <Image height={36} src={logoMXSR} alt="MXSR" />
            </div>
            <div className="col-span-1 flex justify-center md:col-span-3 lg:col-span-1">
              <Image height={36} src={logoQuillette} alt="Quillette" />
            </div>
          </div>
        </div>
      </div>
